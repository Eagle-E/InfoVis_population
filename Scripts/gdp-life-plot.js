...
function selectLegend(opacity, color) {
	return function(d, i) {
		...
		wrapper.selectAll(".countries")
			.filter(function(d) { return d.Region != chosen && chosen != "Selected"; })
			.transition()
...
var color = d3.scale.ordinal()
                    .range(["black", "black", "black", "black", "black", "yellow"])
                    .domain(["Africa", "America", "Asia", "Europe", "Oceania", "Selected"]);
